...
while read gene;
    do
        cp header.meta "metafilesALL/${gene}_CADDALL.meta"
        grep -a -w "$gene" meta_CADDALL.txt >> "metafilesALL/${gene}_CADDALL.meta"
...
while read gene;
    do
        cp header.meta "metafiles15/${gene}_CADD15.meta"
        grep -a -w "$gene" meta_CADD15.txt >> "metafiles15/${gene}_CADD15.meta"
...
while read gene;
    do
        cp header.meta "metafiles20/${gene}_CADD20.meta"
        grep -a -w "$gene" meta_CADD20.txt >> "metafiles20/${gene}_CADD20.meta"
