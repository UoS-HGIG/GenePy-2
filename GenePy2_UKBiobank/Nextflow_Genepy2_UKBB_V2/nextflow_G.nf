...
process Pre_processing_2 {
  ...
  file("f5.vcf.gz")
  output:
  tuple path("c1"), path("c2"), path("c3"), path("c4"),path("c5"),path("c5a"),path("c5b"),path("gene.lst"),path("f5.vcf.gz"),path("header.meta")
...
process Pre_processing_3 {
  publishDir "${params.output}/metafiles", mode: "copy", overwrite: true
  // maxForks 10
  ...
  tuple file("metafiles20/ENSG*CADD20.meta"),file("gene.lst"), emit: meta_files20
  tuple file("metafiles15/ENSG*CADD15.meta"),file("gene.lst"), emit: meta_files15
  tuple file("metafilesALL/ENSG*CADDALL.meta"),file("gene.lst"), emit: meta_filesALL
