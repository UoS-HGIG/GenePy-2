...
process VEP_score {
  ...
  script:
    ...
    vep  -i "p1.vcf" --offline --assembly GRCh38 --vcf --fork 10 --cache --force_overwrite --pick_allele --plugin CADD,"wes.tsv.gz",${params.plugin1},${params.plugin2} --af_gnomade --af_gnomadg -o "${chrx}.p1.vep.vcf" --dir_cache ${params.homos_vep} --dir_plugins ${params.vep_plugins} --dir ${params.homos_vep}
    """
}
